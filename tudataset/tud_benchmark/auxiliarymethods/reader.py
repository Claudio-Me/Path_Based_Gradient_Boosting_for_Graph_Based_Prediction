...
def tud_to_networkx(ds_name, path_to_dataset=None):
    if path is None:
    ...
    with open(path_to_dataset + pre + ds_name + "/raw/" + ds_name + "_graph_indicator.txt", "r") as f:
    ...
    # Edges.
    with open(path_to_dataset + pre + ds_name + "/raw/" + ds_name + "_A.txt", "r") as f:
    ...
    # Node labels.
    if path.exists(path_to_dataset + pre + ds_name + "/raw/" + ds_name + "_node_labels.txt"):
        with open(path_to_dataset + pre + ds_name + "/raw/" + ds_name + "_node_labels.txt", "r") as f:
    ...
    # Node Attributes.
    if path.exists(path_to_dataset + pre + ds_name + "/raw/" + ds_name + "_node_attributes.txt"):
        with open(path_to_dataset + pre + ds_name + "/raw/" + ds_name + "_node_attributes.txt", "r") as f:
    ...
    # Edge Labels.
    if path.exists(path_to_dataset + pre + ds_name + "/raw/" + ds_name + "_edge_labels.txt"):
        with open(path_to_dataset + pre + ds_name + "/raw/" + ds_name + "_edge_labels.txt", "r") as f:
    ...
    # Edge Attributes.
    if path.exists(path_to_dataset + pre + ds_name + "/raw/" + ds_name + "_edge_attributes.txt"):
        with open(path_to_dataset + pre + ds_name + "/raw/" + ds_name + "_edge_attributes.txt", "r") as f:
    ...
    # Classes.
    if path.exists(path_to_dataset + pre + ds_name + "/raw/" + ds_name + "_graph_labels.txt"):
        with open(path_to_dataset + pre + ds_name + "/raw/" + ds_name + "_graph_labels.txt", "r") as f:
    ...
    # Targets.
    if path.exists(path_to_dataset + pre + ds_name + "/raw/" + ds_name + "_graph_attributes.txt"):
        with open(path_to_dataset + pre + ds_name + "/raw/" + ds_name + "_graph_attributes.txt", "r") as f:
